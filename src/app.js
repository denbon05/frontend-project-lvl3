...
const getRSS = (uri) => axios.get(uri)
	.then((response) => {
		...
		if (rssElement) {
			...
			return { error: null, rssElement }
		} else {
			return { error: "This source doesn't contain valid rss" };
		}
	})
	.catch((err) => {
